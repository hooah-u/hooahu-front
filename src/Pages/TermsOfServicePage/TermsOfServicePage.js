    ...
    return (
      <div className="TermsPage">
        ...
        <div className="TermsPage__content">
          <h2>Welcome to HooahU</h2>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of HooahU's Website.
          </p>{" "}
          <br />
          <strong>HooahU</strong> is located at:
          <br />
          <address>
            Yongsan Yongsan-gu, Seoul
            <br />
            Seoul - 04359, South Korea
            <br />
          </address>
          <p>
            By accessing this website we assume you accept these terms and
            conditions in full. Do not continue to use HooahU's website if you
          ...
          <p>
            ...
            of South Korea. Any use of the above terminology or other words in
            the singular, plural, capitalisation and/or he/she or they, are
            taken as interchangeable and therefore as referring to same.
          </p>
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By using HooahU's website you consent
            to the use of cookies in accordance with HooahU’s privacy policy.
          </p>
          <p>
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, HooahU and/or it’s licensors own the
            intellectual property rights for all material on HooahU. All
            intellectual property rights are reserved. You may view and/or print
            pages from <span>http://www.hooahu.com</span> for your own personal
            use subject to restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ol>
            <li>
              Republish material from <span>http://www.hooahu.com</span>
            </li>
            <li>
              Sell, rent or sub-license material from{" "}
              <span>http://www.hooahu.com</span>
            </li>
            <li>
          ...
          <p>
            Redistribute content from HooahU (unless content is specifically
          ...
          <ol>
            ...
            <li>
              ...
              ('Comments') in areas of the website. HooahU does not screen,
              ...
              ofHooahU, its agents or affiliates. Comments reflect the view and
              opinion of the person who posts such view or opinion. To the
              extent permitted by applicable laws HooahUshall not be responsible
            ...
            <li>
              HooahUreserves the right to monitor all Comments and to remove any
            ...
            <li>
              You hereby grant to <strong>HooahU</strong> a non-exclusive
          ...
          <p>
            ...
            hyperlink outweighs the absence of <strong>Hooah!U</strong>; and (d)
          ...
          <p>
            ...
            <a
              href="mailto:hooahukorea@gmail.com"
              title="send an email to hooahukorea@gmail.com"
            >
              hooahukorea@gmail.com
            </a>
          ...
          <p>
            No use of HooahU’s logo or other artwork will be allowed for linking
...
TermsOfServicePage.defaultProps = defaultProps;
