    ...
    return (
      <div className="PrivacyPolicyPage">
        ...
        <div className="PrivacyPolicyPage__content">
          ...
          <p>Effective date: September 08, 2018</p>

          <p>
            HooahU ("us", "we", or "our") operates the http://www.hooahu.com
            website (the "Service").
          </p>
          ...
          <p>HooahU uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            If you are located outside Korea, Republic of and choose to provide
            information to us, please note that we transfer the data, including
            Personal Data, to Korea, Republic of and process it there.
          </p>
          <p>
          ...
          <p>
            HooahU will take all steps reasonably necessary to ensure that your
          ...
          <p>
            HooahU may disclose your Personal Data in the good faith belief that
            such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of HooahU</li>
            <li>
          ...
          <ul>
            <li>By email: hooahukorea@gmail.com</li>
            <li>
              By visiting this page on our website:
              http://www.hooahu.com/contact
            </li>
          </ul>
        </div>
      </div>
...
PrivacyPolicyPage.defaultProps = defaultProps;
